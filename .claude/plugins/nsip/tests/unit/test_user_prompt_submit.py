...
Tests:
- prompt_analyzer.py (merged from prompt_analyzer.py + comparative_analyzer.py)
"""
...
class TestPromptAnalyzer(BaseHookTestCase):
    """Test prompt_analyzer.py hook (merged smart_search_detector + comparative_analyzer)."""
    ...
    def test_detects_single_lpn_id(self):
        ...
        result = self.run_hook('prompt_analyzer.py', input_data)

        self.assertHookContinues(result)
        self.assertTrue(
            result['output']['metadata']['analysis_performed']
        )
        self.assertEqual(
    ...
    def test_handles_empty_prompt(self):
        ...
        self.assertHookContinues(result)
        self.assertFalse(
            result['output']['metadata'].get('analysis_performed', False)
        )
    ...
    def test_logs_detection(self):
        ...
        log_entries = self.env.read_log_file('prompt_analysis.jsonl')
...
class TestComparativeAnalyzer(BaseHookTestCase):
    """Test comparative_analyzer.py hook - now merged into prompt_analyzer.py."""

    def test_placeholder(self):
        """Placeholder - comparative analysis is now handled by prompt_analyzer.py."""
        pass
