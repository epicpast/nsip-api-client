...
class TestUS3ParameterValidation:
    ...
    def test_llm_can_retry_with_correction(self, mock_client_class):
        ...
        # Suggestion says: "Provide full LPN ID (minimum 5 characters, e.g., '6401492020FLE249')"
        ...
        success_response = mcp_tools.nsip_get_animal.fn(search_string="6401492020FLE249")
...
class TestUS3ApiErrorHandling:
    ...
    def test_nsip_api_failure_handling(self, mock_client_class):
        ...
        # Invoke tool
        error_response = mcp_tools.nsip_get_animal.fn(search_string="6401492020FLE249")
...
class TestEndToEndWorkflow:
    ...
    def test_complete_workflow(self, mock_client_class):
        ...
        result_large = mcp_tools.nsip_get_animal.fn(search_string="6401492020FLE249")
        ...
        corrected_response = mcp_tools.nsip_get_animal.fn(search_string="6401492020FLE249")
