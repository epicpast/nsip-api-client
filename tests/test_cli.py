...
class TestCLI:
    ...
    def mock_lineage(self):
        ...
        return {
            "Subject": {"LpnId": "6####92020###249", "FarmName": "[FARM_NAME]"},
            "Sire": {"LpnId": "6####92019###124"},
            "Dam": {"LpnId": "6####92018###035"},
        }
    ...
    def test_search_command_simple(self, mock_animal_details, capsys):
        ...
        with requests_mock.Mocker() as m:
            ...
            exit_code = main(["search", "6####92020###249"])
            captured = capsys.readouterr()

            assert exit_code == 0
            output = json.loads(captured.out)
            assert output["LpnId"] == "6####92020###249"
    ...
    def test_search_command_full(self, mock_animal_details, mock_lineage, mock_progeny, capsys):
        ...
        with requests_mock.Mocker() as m:
            ...
            exit_code = main(["search", "6####92020###249", "--full"])
            captured = capsys.readouterr()
            ...
            assert output["details"]["LpnId"] == "6####92020###249"
