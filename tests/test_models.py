...
class TestAnimalDetails:
    ...
    def test_from_api_response(self, mock_api_response):
        ...
        assert animal.lpn_id == "6401492020FLE249"
    ...
    def test_contact_info_parsing(self, mock_api_response):
        ...
        assert animal.contact_info.farm_name == "Beyond Blessed Farm"
        assert animal.contact_info.phone == "(276)-759-4718"
        assert animal.contact_info.email == "mbfletcher08@gmail.com"
